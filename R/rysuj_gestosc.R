...
rysuj_gestosc <- function(dane){
  ...
  p<-ggplot2::ggplot(dane) + 
    ggplot2::geom_density(ggplot2::aes(najszybsza, colour = "najszybsza"), fill = "red", alpha=0.1, show.legend=TRUE)+
    ggplot2::geom_density(ggplot2::aes(najwolniejsza, colour = "najwolniejsza"), fill = "green", alpha=0.1,show.legend=TRUE)+
