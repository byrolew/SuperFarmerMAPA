#' @export
strategy_HEV <- function(stock_status, max_stock = c("krolik" = 60, "owca" = 24, "swinia" = 20,
  ...
  if (stock_status["kon"] > 1) {
    ...
    return (strategy_get_every_animal(stock_status))
  } else {
    return (strategy_EV(stock_status, max_stock))
  }
}